...
-- Started on 2025-07-26 22:12:26
...
CREATE TABLE public.peoples (
    ...
    genital character varying(500) NOT NULL,
...
--
-- TOC entry 4691 (class 2604 OID 16443)
...
--
-- TOC entry 4695 (class 2604 OID 16534)
...
--
-- TOC entry 4693 (class 2604 OID 16495)
...
--
-- TOC entry 4690 (class 2604 OID 16409)
...
--
-- TOC entry 4689 (class 2604 OID 16391)
...
--
-- TOC entry 4698 (class 2604 OID 16592)
...
--
-- TOC entry 4692 (class 2604 OID 16473)
...
--
-- TOC entry 4891 (class 0 OID 16440)
-- Dependencies: 222
...
--
-- TOC entry 4900 (class 0 OID 16531)
-- Dependencies: 231
...
--
-- TOC entry 4905 (class 0 OID 16593)
-- Dependencies: 236
-- Data for Name: people_services; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.people_services (person_id, service_id) FROM stdin;
1	1
1	2
1	3
\.
...
--
-- TOC entry 4896 (class 0 OID 16503)
-- Dependencies: 227
...
--
-- TOC entry 4895 (class 0 OID 16492)
-- Dependencies: 226
-- Data for Name: peoples; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.peoples ("ID", full_name, district_id, phone_number, price, hotel_price, year_of_birth, hight, weight, "V1", "V2", "V3", genital, service_time) FROM stdin;
1	Nguyễn Thị A	1	0123456789	5	200	1994	160	45	50	60	70	abc def ghi jkl mno	60
\.
...
--
-- TOC entry 4889 (class 0 OID 16406)
-- Dependencies: 220
...
--
-- TOC entry 4887 (class 0 OID 16388)
-- Dependencies: 218
...
--
-- TOC entry 4903 (class 0 OID 16582)
-- Dependencies: 234
...
--
-- TOC entry 4893 (class 0 OID 16470)
-- Dependencies: 224
...
--
-- TOC entry 4902 (class 0 OID 16569)
-- Dependencies: 233
-- Data for Name: work_shifts; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.work_shifts ("ID", people_id, is_24h, start_time, end_time) FROM stdin;
\.
...
SELECT pg_catalog.setval('public."overnight_option_ID_seq"', 1, false);
...
--
-- TOC entry 4722 (class 2606 OID 16536)
...
ALTER TABLE ONLY public.people_services
    ADD CONSTRAINT people_services_person_id_service_id PRIMARY KEY (person_id, service_id);


--
-- TOC entry 4718 (class 2606 OID 16507)
...
--
-- TOC entry 4704 (class 2606 OID 16490)
...
--
-- TOC entry 4706 (class 2606 OID 16413)
...
--
-- TOC entry 4702 (class 2606 OID 16395)
...
--
-- TOC entry 4728 (class 2606 OID 16588)
...
--
-- TOC entry 4712 (class 2606 OID 16486)
...
--
-- TOC entry 4732 (class 2606 OID 16456)
...
--
-- TOC entry 4734 (class 2606 OID 16518)
...
--
-- TOC entry 4739 (class 2606 OID 16608)
-- Name: people_services people_services_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.people_services
    ADD CONSTRAINT people_services_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.peoples("ID") ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- TOC entry 4736 (class 2606 OID 16598)
...
--
-- TOC entry 4735 (class 2606 OID 16620)
-- Name: peoples peoples_price_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.peoples
    ADD CONSTRAINT peoples_price_fkey FOREIGN KEY (price) REFERENCES public.prices_list("ID") ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- TOC entry 4733 (class 2606 OID 16480)
...
-- Completed on 2025-07-26 22:12:26
